...
import { loadRacingGames } from "../../actions/gamesAction";
...
const RacingGames = () => {
  const games = useSelector((state) => state.games.genreRacing);
  ...
  useEffect(() => {
    dispatch(loadRacingGames(pageNumber, ordering, platform));

...
import { loadPuzzleGames } from "../../actions/gamesAction";
...
const PuzzleGames = () => {
  const games = useSelector((state) => state.games.genrePuzzle);
  ...
  useEffect(() => {
    dispatch(loadPuzzleGames(pageNumber, ordering, platform));

...
import { loadAdventureGames } from "../../actions/gamesAction";
...
const AdventureGames = () => {
  const games = useSelector((state) => state.games.genreAdventure);
  ...
  useEffect(() => {
    dispatch(loadAdventureGames(pageNumber, ordering, platform));

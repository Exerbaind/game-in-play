...
import { loadShooterGames } from "../../actions/gamesAction";
...
const ShooterGames = () => {
  const games = useSelector((state) => state.games.genreShooter);
  ...
  useEffect(() => {
    dispatch(loadShooterGames(pageNumber, ordering, platform));

...
import { loadIndieGames } from "../../actions/gamesAction";
...
const IndieGames = () => {
  const games = useSelector((state) => state.games.genreIndie);
  ...
  useEffect(() => {
    dispatch(loadIndieGames(pageNumber, ordering, platform));
